...
namespace ColorUniversalDesignLibrary.ColorBlindnessSimulator
{
    ...
    internal class ColorBlindnessSimulatorHelper
    {
        ...
        internal static byte[] SimulateProtanopia(byte[] bgra8SourcePixels)
        {
            return SimulateColorBlindness(bgra8SourcePixels, ProtanopiaParameters);
        }

        internal static byte[] SimulateTritanopia(byte[] bgra8SourcePixels)
        {
            return SimulateColorBlindness(bgra8SourcePixels, TritanopiaParameters);
        }

        internal static byte[] SimulateDeuteranopia(byte[] bgra8SourcePixels)
        {
        ...
        private static float SRgbToLinearRgb(byte input)
        {
            ...
            return (float)Math.Pow((floatInput + 0.055f) / 1.055f, 2.4f);
        }
        ...
        private static byte LinearRgbToSRgb(float input)
        {
            ...
            return (byte)(255f * (Math.Pow(input, 1f / 2.4f) * 1.055f - 0.055f));
        }
    }
